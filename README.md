...
* The default region and availability zone will be used
...
* [OpenStack](http://www.openstack.org/) Mitaka cloud (may work on earlier versions), the [`openstack` cli tool for your platform](http://docs.openstack.org/user-guide/common/cli-install-openstack-command-line-clients.html) and [jq](https://stedolan.github.io/jq) (1.5+)
